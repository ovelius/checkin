		...
		<div id="list-customer" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="reg" title="${message(code: 'customer.reg.label', default: 'Reg')}" />
					
						<g:sortableColumn property="location" title="${message(code: 'customer.location.label', default: 'Location')}" />
				...
				<g:each in="${customerInstanceList}" status="i" var="customerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: customerInstance, field: "reg")}</td>
					
						<td>${fieldValue(bean: customerInstance, field: "location")}</td>
