		...
		<div id="list-checkIn" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="time" title="${message(code: 'checkIn.time.label', default: 'Time')}" />
				...
				<g:each in="${checkInInstanceList}" status="i" var="checkInInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: checkInInstance, field: "shop")}</td>
					
						<td><g:formatDate date="${checkInInstance.time}" /></td>
